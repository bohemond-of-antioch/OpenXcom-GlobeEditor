Public Class CVector
	...
	Public Shared Function LinesIntersection(LA1 As CVector, LA2 As CVector, LB1 As CVector, LB2 As CVector) As CVector
		Dim a1x, a1y, s1x, s1y As Single
		a1x = LA1.X
		a1y = LA1.Y
		s1x = LA2.X - LA1.X
		...
		Catch ex As Exception
			Return Nothing
		End Try
		If t2 >= 0 AndAlso t2 <= 1 AndAlso t1 >= 0 AndAlso t1 <= 1 Then
			Return New CVector(a1x + s1x * t1, a1y + s1y * t1)
		Else
			Return Nothing
		End If
	End Function
